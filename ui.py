...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.question_text = self.canvas.create_text(150, 125, text="Simple text",
                                                     width=280, font=("Arial", 15, "italic"))
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            messagebox.showinfo(title="Final Result",
                                message=f"Congratulations! Your final score is {self.quiz.score}")
